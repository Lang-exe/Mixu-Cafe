    ...
    <div id="content-container">
      <div id="page_input_page_ek1">
        ...
        <div id="stok_produk" style="top:-100px">
          ...
          <div id="stok_produk">
            <input type="number" value='0' name ="stok" id="stok" style="border: 0ch; margin-left: -85px; height: 20px; width: 250px; outline: 0ch; font-size: 20px" />
          </div>
          <div id="harga_produk">
            <input type="number" value='0' name ="harga" id="harga" style="border: 0ch; margin-left: -85px; height: 20px; width: 250px; outline: 0ch; font-size: 20px" />
          </div>
          </div>
        </div>
